package fr.guddy.androidstarteralt.tests.ui;
...
public class TestActivityRepoList extends AbstractRobotiumTestCase<ActivityMain> {
    ...
    public void test_ListRepos_WithOneRepo_DisplayListWithOnlyThisRepo() {
        Given:
        {
            final String lsOneRepoJSONData = mLocalifyClient.localify().loadRawFile(fr.guddy.androidstarteralt.test.R.raw.repos_octocat);
